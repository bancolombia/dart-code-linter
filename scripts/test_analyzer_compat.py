...
VERSION_PAIRS = [
    ...
    (
        # 13.2+ deprecated MethodDeclaration.isAbstract in favour of isComplete;
        # 13.0.0 (above) predates that. This row covers the post-deprecation
        # side so ast_compat.isAbstractMethod stays valid on both.
        "13.3.0",
        "0.14.12",
        {
