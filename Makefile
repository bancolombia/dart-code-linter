...
help:
	...
	@echo "  test-analyzer-compat      Analyze lib/ with analyzer 8.x, 9.x, 10.x, 11.x, 12.x, 13.x, 14.x"
	@echo "  test-analyzer-compat-full Run full dart test with analyzer 8.x, 9.x, 10.x, 11.x, 12.x, 13.x, 14.x"
