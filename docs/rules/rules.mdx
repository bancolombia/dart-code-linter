...
<Admonition type="info" icon="-" title="avoid-non-exhaustive-switch-on-sealed-classes
">
  <p>

Warns when a switch over a sealed type uses a default or wildcard case that prevents compiler-enforced exhaustiveness checking.
style
  </p>
</Admonition>
...
<Admonition type="info" icon="-" title="prefer-dot-shorthands
">
  <p>
...
<Admonition type="info" icon="-" title="prefer-named-record-fields
">
  <p>

Warns when positional record fields are used instead of named record fields for better code readability.
style
🛠
  </p>
</Admonition>
...
<Admonition type="info" icon="-" title="avoid-non-configurable-callbacks-in-init-state
">
  <p>

Warns when State.initState configures a widget-supplied object with a callback object whose named callback parameters do not reference the widget's own fields, leaving callers no way to customize the behavior.
warning
  </p>
</Admonition>
...
<Admonition type="info" icon="-" title="prefer-media-query-direct-access
">
  <p>

Warns when MediaQuery properties are accessed through MediaQuery.of(context).property instead of using direct access methods.
style
🛠
  </p>
</Admonition>
